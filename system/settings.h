...
gchar*          settings_get_sysfs_suspend_input_path  (Settings *settings);
gint            settings_get_sysfs_suspend_input_value (Settings *settings);
gint            settings_get_sysfs_resume_input_value  (Settings *settings);
G_END_DECLS
